...
### Fixed
- Corrected the repository URLs in package metadata (`pyproject.toml`) and this
  changelog to point at `https://github.com/ErrSight/errsight-py`.
...
[0.1.1]: https://github.com/ErrSight/errsight-py/releases/tag/v0.1.1
[0.1.0]: https://github.com/ErrSight/errsight-py/releases/tag/v0.1.0
